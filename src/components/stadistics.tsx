...
export function Stadistics() {
  return (
    <Card className="ml-5 max-w-full">
      <h3 className="text-tremor-title text-tremor-content-strong dark:text-dark-tremor-content-strong font-medium">Análisis de  contenido</h3>
